...
class Product {
  ...
  static async create({ name, description, price, stockQuantity, isActive }) {
    // RETURNING para retornar os resultados inseridos. Pode ser usado em vários comandos no postgres inclusive é possível especificar os campos que serão retornados. EX: RETURNING id, name
